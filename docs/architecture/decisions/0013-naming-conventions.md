...
2. Update CLAUDE.md with backend naming quick reference
3. Create PR template checklist for naming conventions

### Phase 2: Linting
1. Add ESLint rules for Convex directory:
   ```json
   {

...
- Always include all index fields in the index name. Preserve camelCase field names, use underscore only as separator. For example, if an index is defined as `["createdBy", "artifactId"]`, the index name should be `by_createdBy_artifactId`.

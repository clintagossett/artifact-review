...
- [Third-party services and subprocessors](#third-party-services-and-subprocessors)
...
- [What happens when you delete content](#what-happens-when-you-delete-content)
...
1. **The use is necessary to fulfill our commitments to you** under the applicable Terms of Service or other agreements, or to administer your account — for example, to enable access to our Services or charge you for a paid plan.
...
4. **We have a legitimate interest** in using your information — for example, to provide and update our Services, to improve our Services, to safeguard our Services, to communicate with you, and to monitor and prevent problems.
5. **You have given us your consent** — for example, before we place certain non-essential cookies on your device.

---

## When we access or disclose your information

**To provide products or services you've requested.** We use some third-party subprocessors to help run our applications and provide the Services to you. See the [Third-party services and subprocessors](#third-party-services-and-subprocessors) section below for a complete list.
...
- **Preservation requests.** Our policy is to comply with requests to preserve data only if compelled by the U.S. Federal Stored Communications Act, 18 U.S.C. Section 2703(f), or by a properly served U.S. subpoena for civil matters.
...
|---------|---------|----------------|----------|----------------|
| **Stripe** | Payment processing | Name, email, billing address, payment method (credit card info goes directly to Stripe, not our servers) | United States | [stripe.com/privacy](https://stripe.com/privacy) |
| **Clerk** | Authentication & user management | Email, name, password (hashed), OAuth tokens, IP address, session data | United States | [clerk.com/legal/privacy](https://clerk.com/legal/privacy) |
| **Convex** | Backend database & serverless functions | All application data (artifacts, comments, user profiles, team data) | United States | [convex.dev/legal/privacy](https://www.convex.dev/legal/privacy) |
| **Novu** | Notification delivery | Email address, notification preferences, notification content | United States | [novu.co/privacy](https://novu.co/privacy) |
| **Vercel** | Web hosting & CDN | IP addresses, request logs, performance data, geographic location (approximate) | United States | [vercel.com/legal/privacy-policy](https://vercel.com/legal/privacy-policy) |
...
**Essential cookies.** These are required for the Services to function properly. They include authentication cookies (managed by Clerk), session management cookies, and security cookies. You cannot opt out of essential cookies while using our Services.
...
If you have questions about exercising these rights or need assistance, please contact us at [privacy@artifactreview.com](mailto:privacy@artifactreview.com).
...
|-----------|-----------------|
| Account information (name, email) | Duration of account + 60 days after deletion |
...
If you have questions about international data transfers, please contact us at [privacy@artifactreview.com](mailto:privacy@artifactreview.com).
...
Our Services are not directed to children under the age of 16. We do not knowingly collect or solicit personal information from anyone under 16. If we learn that we have collected personal information from a child under 16, we will promptly delete that information. If you believe that a child under 16 may have provided us with personal information, please contact us at [privacy@artifactreview.com](mailto:privacy@artifactreview.com).
...
Have any questions, comments, or concerns about this privacy policy, your data, or your rights with respect to your information? Please get in touch by emailing us at [privacy@artifactreview.com](mailto:privacy@artifactreview.com) and we'll be happy to try to answer them!

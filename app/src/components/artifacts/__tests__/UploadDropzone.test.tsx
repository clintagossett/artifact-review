...
describe("UploadDropzone", () => {
  describe("rendering and initial state", () => {
    ...
    it("should have proper accessibility attributes", () => {
      ...
      const dropzone = screen.getByLabelText("Drop zone for file upload");
  ...
  describe("file picker interaction", () => {
    ...
    it("should trigger file picker on Enter key press", async () => {
      ...
      const dropzone = screen.getByLabelText("Drop zone for file upload");
      const fileInput = screen.getByLabelText(/upload artifact file/i) as HTMLInputElement;
  ...
  describe("file-selected state", () => {
    it("should show selected file name and size", async () => {
      ...
      render(<UploadDropzone onFileSelect={handleFileSelect} selectedFile={file} />);

...
describe("IconInput", () => {
  ...
  it("should render icon on left side", () => {
    const { container } = render(<IconInput icon={Mail} />);
  ...
  it("should have gray background", () => {
    render(<IconInput icon={Mail} placeholder="test" />);
  ...
  it("should accept custom className", () => {
    render(<IconInput icon={Mail} placeholder="test" className="custom-class" />);
    const input = screen.getByPlaceholderText("test");
